...
class Special(_Mode):
    ...
    def make_panels(self):
        ...
        self.start_waiting_mode = {"Push": "DIRECTION", "Portal": "WORLD"}
        self.waiting_mode = None
        self.args = []

        self.prompts_push = {
            "DIRECTION": "Enter pushable directions ('1111'='NESW'): ",
            "STACKED": "Number Stacked: ",
            "ID": "Identifier key: ",
        }
        self.checks_push = {
            "DIRECTION": self.check_direction_input,
            "STACKED": self.check_stack,
            "ID": self.check_non_empty,
        }
        self.nexts_push = {"DIRECTION": "STACKED", "STACKED": "ID", "ID": "DONE"}

        self.prompts_portal = {
            "WORLD": ("Enter world map name: "),
            "MAP_COORDS": "Enter map coordinates: ",
            "START_COORDS": "Enter start position within map: ",
        }
        self.checks_portal = {
            "WORLD": self.check_non_empty,
