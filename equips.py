...
class _Equipment(object):
    ...
    def get_images(self, sheet, coords, step=prepare.CELL_SIZE[0]):
        ...
        for i, direction in enumerate(["front", "back", "left", "right"]):
            ...
            images[direction] = sheet.subsurface(pg.Rect(location, prepare.CELL_SIZE))
        return images
...
class Helm(_Equipment):
    ...
    def __init__(self):
        ...
        self.title = "Helm"
        self.descript = ["Average defense, average visibility.", "Just pretty average."]
        self.vision_impair = None
...
class Diver(_Equipment):
    ...
    def __init__(self):
        ...
        self.descript = [
            "Underwater breathing, and you can almost see",
...
class TopGoggles(_Equipment):
    ...
    def __init__(self):
        ...
        self.descript = [
            "Wait, I don't get it.  Are there holes in the",
...
class Cloth(_Equipment):
    ...
    def __init__(self):
        ...
        self.descript = ["Leaves something to be desired", "in the defense department."]
...
class ChainMail(_Equipment):
    ...
    def __init__(self):
        ...
        self.descript = ["What it has in defense,", "it lacks in freedom of movement."]
...
class TinShield(_Equipment):
    ...
    def __init__(self):
        ...
        self.descript = ["Only slightly better than", "having no shield at all."]
        self.deflect = 1
...
class ArmsLegs(_Equipment):
    ...
    def get_images(self, sheet, sheet_pos):
        ...
        shield.
        """
        frames = tools.strip_from_sheet(sheet, sheet_pos, prepare.CELL_SIZE, 18)
        self.images = {}
        self.attack_images = {}
...
class AttackSprite(pg.sprite.Sprite):
    ...
    def get_attack_position(self, player_rect, direction):
        ...
        """
        set_direction = {
            "back": ("midbottom", player_rect.midtop),
...
_BODIES = {"cloth": Cloth, "chain": ChainMail}

_SHIELDS = {"none": NoShield, "tin": TinShield}

_ARMS_LEGS = {"normal": ArmsLegs}

_WEAPONS = {"pitch": PitchFork, "labrys": Labrys}
